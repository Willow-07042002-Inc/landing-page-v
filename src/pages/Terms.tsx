        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-3xl mx-auto py-[16px]">
            ...
            color: '#222222'
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">1. Who We Are</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">2. What We Do</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">3. Subscriptions & Payments</h2>
              <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">4. What You're Responsible For</h2>
              <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">5. What We're Not Responsible For - Legal Advice</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">6. Ownership & Restrictions</h2>
              <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">7. Account Termination</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">8. Liability</h2>
              <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">9. Privacy</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">10. Service Availability</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">11. Canceling Your Account</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">12. Death of User</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">13. Dispute Resolution</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">14. Governing Law</h2>
              ...
              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">15. Changes to These Terms</h2>
              <p className="text-base leading-relaxed mb-6">We may update these Terms from time to time. If we do, we'll let you know.</p>

              <h2 className="text-2xl font-heading font-semibold mb-4 mt-10">16. Getting in touch with Us</h2>
