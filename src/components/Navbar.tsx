...
const Navbar = () => {
  ...
  const isMarketingPage = ["/", "/attorneys", "/for-clients", "/news", "/terms", "/privacy", "/contact", "/investors", "/careers", "/founding-100", "/nysba", "/request-access", "/book"].includes(location.pathname)
  ...
  const alwaysSmallPages = ["/availability-map", "/terms", "/privacy", "/contact", "/investors", "/careers", "/founding-100", "/nysba", "/learn", "/book", "/request-access", "/pitol"];
        ...
        <div className={`flex ${isHomePage || isAboutUsPage ? 'items-center' : scrolled || isAlwaysSmallPage ? 'items-center' : 'items-end'} transition-all duration-300 ${
          isCreateWillPage 
            ...
            : scrolledPastHero || isAlwaysSmallPage
              ? 'lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2 absolute left-0 ml-[54px] lg:ml-0' 
